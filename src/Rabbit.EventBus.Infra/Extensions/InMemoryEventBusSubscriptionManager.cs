...
namespace Rabbit.EventBus.Infra.Extensions
{
    public class InMemoryEventBusSubscriptionManager : IEventBusSubscriptionManager
    {
        ...
        /// <summary>
        /// RRetorna o dicionário de assinaturas de forma imutável.
        /// </summary>
        ...
        private void DoAddSubscription(Type eventType, Type handlerType, string eventName)
        {
            ...
            {
                throw new ArgumentException($"Handler Tipo {handlerType.Name} já foi registrado para '{eventName}'", nameof(handlerType));
            }
